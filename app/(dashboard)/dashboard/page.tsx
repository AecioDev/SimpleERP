...
import { BarChart3, ShoppingCart, Package, Wallet, TrendingUp } from "lucide-react"
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+12 novos produtos este mês</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="col-span-1">
          <CardHeader>
            ...
            <CardDescription>Últimas 5 vendas realizadas no sistema</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-4 border-b pb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Há {i + 1} horas</p>
                  </div>
                </div>
              ))}
            </div>
