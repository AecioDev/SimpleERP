...
const FinancialService = {
  ...
  async updateTransaction(id: number, transaction: UpdateTransactionDto): Promise<FinancialTransaction> {
    const response = await api.put(`/financial/transactions/${id}`, transaction)
    return response.data
  },
